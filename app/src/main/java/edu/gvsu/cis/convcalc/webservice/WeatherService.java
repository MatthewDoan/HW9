...
public class WeatherService extends IntentService {
    ...
    private static final String ACTION_WEATHER_AT = "edu.gvsu.cis.edu.gvsu.cis.convcalc.webservice.action.WEATHER_AT";
    private static final String BASE_URL = "https://api.openweathermap.org/data/2.5/weather?units=imperial&";
    public static final String BROADCAST_WEATHER = "edu.gvsu.cis.edu.gvsu.cis.convcalc.webservice.action.BROADCAST";
    private static final String EXTRA_KEY = "edu.gvsu.cis.edu.gvsu.cis.convcalc.webservice.extra.KEY";
    private static final String EXTRA_LAT = "edu.gvsu.cis.edu.gvsu.cis.convcalc.webservice.extra.LAT";
    private static final String EXTRA_LNG = "edu.gvsu.cis.edu.gvsu.cis.convcalc.webservice.extra.LNG";
    ...
    private void fetchWeatherData(String key, String lat, String lon) {
        try {
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                ...
                JSONObject weatherNext = weather.getJSONObject(0);
                String summary = weatherNext.getString("main");
                String icon = "img"+weatherNext.getString("icon");
